...
from sklearn import metrics  # moved to predict.py part, can be deleted later on
...
def main():
    ...
    for epoch in range(1, epochs + 1):
        ...
        logging.debug("\ACC:", average_acc, "\tLoss:", average_loss)
